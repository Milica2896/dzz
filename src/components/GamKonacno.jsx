...
import slika1 from '../assets/ai.png';
import slika2 from '../assets/beta.jpg';
import slika3 from '../assets/dz.jpeg';
import slika4 from '../assets/v.jpeg';
...
export default function GamKonacno({ mode, difficulty1, difficulty2, setModeSelection }) {
    ...
    useEffect(() => {
        ...
        async function getAiMove() {
            ...
            try {
                const response = await axios.post('https://project-backend-lake.vercel.app/game/move/', gameData);
...
const humanAiImages = {
  ...
  <h3>Player White</h3>
  <div className="layer-content player-content">
    ...
    />
      ...
      {<div style={{width: "100%", padding: "0%", margin: "0%"}}>
        ...
        <div className='game-header'>
                <button className='game-button' onClick={() => setModeSelection(true)}><i className="ri-home-smile-line"></i>Home</button>
            </div>
